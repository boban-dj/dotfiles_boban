...
# Exiftools-stripexif python-fu pour Gimp 2
...
#
Photolab_exiftools_stripexif_help = _("A batch process on photos with EXIF data in a directory. Strip all unnecessary data from EXIF.")                                
Photolab_exiftools_stripexif_description = Photolab_exiftools_stripexif_help
...
def process_files( 
  ...
  for filepathname in filepathnames:
    os.system( "jhead -purejpg "+"\""+filepathname+"\"")
...
register(
  "python-fu-exiftools-stripexif",
  Photolab_exiftools_stripexif_description,
  Photolab_exiftools_stripexif_help,
  "Raymond Ostertag",
  "GPL License",
  "2009",
  _("Strip EXIF"),
