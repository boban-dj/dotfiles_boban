...
(script-fu-register "script-fu-hmagalhaes-layers-export-css"
	"<Image>/Image/Web Sprites/Export CSS file"
    "Exports an CSS file containing rules to use the current image as an CSS web sprite, where each layer is an element/selector."
    "hudson@hmagalhaes.eti.br"
    "Hudson Pena Magalhães"
    "Dec 12th, 2011"
    "INDEXED* RGB* GRAY*"
	SF-IMAGE "Image to use" 0
	SF-STRING "CSS file (output file)" "sprites.css"
	SF-DIRNAME "CSS file directory" "~"
	SF-STRING "Image file (bkg-image)" "sprites.png"
	SF-STRING "Selectors prefix" ""
	SF-STRING "Selectors postfix" ""
	SF-OPTION "Bkg Repeat" '("no-repeat" "Leave it Blank!" "repeat" "repeat-x" "repeat-y")
	SF-STRING "Abstraction selector" ""
	SF-TOGGLE "Group up selectors" 1
	SF-TOGGLE "Include layer width" 1
	SF-TOGGLE "Include layer height" 1
	SF-TOGGLE "Set scale in group/abstraction" 0
	SF-TOGGLE "Keep white spaces" 1
	SF-TOGGLE "Keep line breaks" 1
	SF-TOGGLE "Remove file extension" 1
)
