...
alias calibrate='xsetwacom --set "9" MaptoOutput 1600x1200+1680+0'
...
alias glue='/home/boban/Snakepit/glue_sprites/bin/glue'

# Systemd support (systemctl start,restart,stop,enable,status,disable)
...
#################################################################################
## when shortcuts
alias whenb='when --calendar_today_style="bold,fgred,bgcyan" cw'
alias when_year='when --past=0 --future=365 c'
